...
if upload_file:
    ...
    if frequency==0:
        signal_figure= px.line(y_signal,x_signal,y_signal, title="Reconstructed signal that is almost a line")
    else:  
        signal_figure= px.line(y_signal,x_signal,y_signal, title="The normal signal")  
        ...
        signal_figure = px.line(x=t, y=y_signal).update_layout(xaxis_title="Time (Sec)", yaxis_title="Amplitude")
